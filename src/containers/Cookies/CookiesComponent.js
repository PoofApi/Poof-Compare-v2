    ...
    return(
        <div className="cookiesComponentPage">
            ...
            <div className="cookiesParagraph">
                ...
                {/* <p>
                    You can exercise your cookie rights by setting your preferences in the Cookie Consent Manager. The Cookie Consent Manager allows you to select which categories of cookies you accept or reject. Essential cookies cannot be rejected as they are strictly necessary to provide you with services.
                </p> */}
...
<div className="cookiesParagraph">
    ...
    <div className="cookiesParagraph">
        <p>
            If you have any questions about our use of cookies or other technologies, please email us at epalumbo@poofapi.com or send us a message through our contact page: <Link className="contactPageLink" to={'/contactPoof'}>here</Link>.
        </p>
    </div>
