  ...
  return (
    <div className="termsComponentPage">
      ...
      <div>
        ...
        <strong className="dateUpdatedAndContactInfo">Last updated November 09, 2020</strong>


        <h4 className="termsHeading">AGREEMENT TO TERMS</h4>
        
        <div className="termsParagraph">
          <p>
            These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Poof! Price Compare, doing business as Poof! ("<strong>Poof!</strong>", “<strong>we</strong>”, “<strong>us</strong>”, or “<strong>our</strong>”), concerning your access to and use of the <a className="termsLink" href="https://www.poofpricecompare.com">https://www.poofpricecompare.com</a> website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
          </p>
          <p>
        ...
        <h4 className="termsHeading">MOBILE APPLICATION LICENSE</h4>
        <p>
          <h6 className="termsSubHeading">Use License</h6>
          <div className="termsParagraph">
            <p>
          ...
          <h6 className="termsSubHeading">Apple and Android Devices</h6>
          <div className="termsParagraph">
            <p>
        ...
        <h4 className="termsHeading">SUBMISSIONS</h4>
        <div className="termsParagraph">
          <p>
        ...
        <h4 className="termsHeading">THIRD-PARTY WEBSITE AND CONTENT</h4>
        <div className="termsParagraph">
          <p>
        ...
        <h4 className="termsHeading">ADVERTISERS</h4>
        <div className="termsParagraph">
        ...
        <h4 className="termsHeading">SITE MANAGEMENT</h4>
        <div className="termsParagraph">
        ...
        <h4 className="termsHeading">PRIVACY POLICY</h4>
        <div className="termsParagraph">
        ...
        <h4 className="termsHeading">TERM AND TERMINATION</h4>
        <div className="termsParagraph">
          <p>
        ...
        <h4 className="termsHeading">MODIFICATIONS AND INTERRUPTIONS</h4>
        <div className="termsParagraph">
          <p>
        ...
        <h4 className="termsHeading">GOVERNING LAW</h4>
        <div className="termsParagraph">
        ...
        <h4 className="termsHeading">DISPUTE RESOLUTION</h4>
          {/*Previously includes subHeading*/}

          {/* <h6 className="termsSubHeading">Binding Arbitration</h6>
            <div className="termsParagraph">
          ...
          <h6 className="termsSubHeading">Restrictions</h6>
            <div className="termsParagraph">
              <p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.</p>
            </div>
          <h6 className="termsSubHeading">Exceptions to Arbitration</h6>
            <div className="termsParagraph">
        ...
        <h4 className="termsHeading">CORRECTIONS</h4>
        <div className="termsParagraph">
        ...
        <h4 className="termsHeading">DISCLAIMER</h4>
        <div className="termsParagraph">
        ...
        <h4 className="termsHeading">LIMITATIONS OF LIABILITY</h4>
        <div className="termsParagraph">
        ...
        <h4 className="termsHeading">INDEMNIFICATION</h4>
        <div className="termsParagraph">
        ...
        <h4 className="termsHeading">USER DATA</h4>
        <div className="termsParagraph">
          <p>We will maintain certain data that you transmit to the Site for the purpose of managing the performance of the Site, as well as data relating to your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Site. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
        </div>

        <h4 className="termsHeading">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h4>
        <div className="termsParagraph">
        ...
        <h4 className="termsHeading">CALIFORNIA USERS AND RESIDENTS</h4>
        <div className="termsParagraph">
          <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
        </div>

        <h4 className="termsHeading">MISCELLANEOUS</h4>
        <div className="termsParagraph">
        ...
        <div className="termsParagraph">
          <p>
            In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us through our contact page: <Link className="contactPageLink" to={'/contactPoof'}>here</Link>.
          </p>
          <p>Or email us at:</p>
          <p>
