                    ...
                    <div className="container-fluid poofDesktopContainer">
                        ...
                        <FadeTransform in
                            ...
                            <div className="poofHeadline row justify-content-center">
                                ...
                                <h5 className="poofTitleText col-8 col-md-6">The best way to search the web for the best deals! Search your favorite big box retailers, such as Amazon, Ebay, and BestBuy, all at once!</h5>
                            </div>
                        </FadeTransform>
